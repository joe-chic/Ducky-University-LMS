...
-- Cover images: loaded AFTER all resources exist (see end of file). Early INSERT here broke FKs (5003+ did not exist yet).
...
-- Cover images (picsum seed per resource_id). Must run after resources 5001–5038 exist.
INSERT INTO images(image_id, resource_id, image_url, image_caption)
VALUES
  (9501, 5001, 'https://picsum.photos/seed/ducky5001/400/600', 'Cover image (dummy)'),
